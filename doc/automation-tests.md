...
You may use [Robot Framework](http://robotframework.org/ "Web site of Robot Framework"), a powerful tool which provides API to describe test cases.  
_Robot Framework_ works well with other tools like [Appium](http://appium.io/ "Appium") if you want to process tests in mobile or web apps.  
